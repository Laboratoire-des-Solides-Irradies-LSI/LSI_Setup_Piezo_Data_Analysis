...
plt.plot(data.time[min_idx:max_idx:skip] * 1e3, data.voltage[min_idx:max_idx:skip], label="Measurement", color=plt.cm.plasma(.3))
plt.plot(data.time[min_idx:max_idx:skip] * 1e3, data.voltage[min_idx:max_idx:skip]/specs['gam'].nominal_value, label="Adjusted Measurement ", color=plt.cm.plasma(.8))

plt.plot(data.time[min_idx:max_idx:skip] * 1e3, model_trace[min_idx:max_idx:skip], label="Model", color='black', alpha=0.4)
